...
<div class="content">
  ...
  <div class="grid-container">
      ...
      <div class="grid-item" style="background-color: #204162;">
	      <div class="acct-name">${cashAccount.accountName}<div class="dots"><i class="fa fa-ellipsis-v" aria-hidden="true"></i></div></div>       
	      <div class="acct-number">${cashAccount.accountNumber}</div>
	      <br><br>
	      <div class="acct-avalbal"><fmt:formatNumber type="currency" value="${cashAccount.avalBalance}" /></div>
	      <div class="acct-number">Available Balance</div>  
	      <br>
	      <div class="acct-number">Current Balance</div>
	      <div class="acct-number"><fmt:formatNumber type="currency" value="${cashAccount.currentBalance}" /></div>
      </div>
...
<br><br>
  ...
  <div class="grid-container-txns">
	  ...
	  <c:forEach var="detail" items="${cashAccountDetails}" varStatus="loop">
